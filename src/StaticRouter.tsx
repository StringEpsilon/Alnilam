...
class StaticRouter extends React.Component<StaticRouterProps> {
	static propTypes: { basename: PropTypes.Requireable<string>; context: PropTypes.Requireable<object>; location: PropTypes.Requireable<string | object>; };
	navigateTo(location: Location, action: any /*TODO*/) {
	...
	handlePush = (location: Location) => this.navigateTo(location, "PUSH");
	handleReplace = (location: Location) => this.navigateTo(location, "REPLACE");
	handleListen = () => noop;
	handleBlock = () => noop;
