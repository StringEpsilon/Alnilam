...
When `true`, the trailing slash on a location's `pathname` will be taken into consideration when determining if the location matches the current URL. See the [`<Route strict>`](./Route.md#strict-bool) documentation for more information.
...
To compare to a different location, a [`location`](.api/location.md) can be passed.
